# Experiment Brief: 20251230-ros-alth-gpu-cifar10

ID: 20251230-ros-alth-gpu-cifar10
Owner: TBD
Date: 2025-12-30
Hypothesis:
  On GPU, the full Operator Basis Layer (K=59) remains stable on CIFAR-10 and
...
Baseline:
  ...
  Dataset: torchvision CIFAR-10 (downloaded to project/data)
Change:
...
Notes:
  ...
  - This is a short-run (5 epochs) comparison for speed; not final accuracy.
