...
Baseline:
  ...
  Config: CIFAR-10, batch 128, seeds 1,2,3, FP32, fixed augmentation,
          baseline model from project/grad-speedup/src with SGD (momentum 0.9) and Adam.
Change:
...
Primary metric:
  Cost-to-target C(A*) and steps-to-target T(A*) for A* in {0.85, 0.90, 0.92, 0.94}.
Quality guardrail:
...
Notes:
  ...
  - Early stop once highest A* threshold is reached.
