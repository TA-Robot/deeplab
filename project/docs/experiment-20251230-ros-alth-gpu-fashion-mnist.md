# Experiment Brief: 20251230-ros-alth-gpu-fashion-mnist

ID: 20251230-ros-alth-gpu-fashion-mnist
Owner: TBD
Date: 2025-12-30
Hypothesis:
  On GPU, the full Operator Basis Layer (K=59) remains stable on Fashion-MNIST and
...
Baseline:
  ...
  Dataset: torchvision Fashion-MNIST (downloaded to project/data)
Change:
